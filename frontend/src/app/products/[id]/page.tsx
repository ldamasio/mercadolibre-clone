  ...
  return (
    <div className="min-h-screen bg-custom-gray">
      ...
      <main className="border-2 border-blue-500 w-full flex flex-col items-center">
        {/* Main Content - Desktop 3 columns layout with fixed widths */}
        <div className="border-2 border-red-500 w-[1184px] mx-auto">
        {/* Breadcrumb */}
        <div className="mb-4 text-sm w-full">
          <Breadcrumb items={breadcrumbItems} />
        </div>
          {/* Gallery Column - Fixed width 478px */}
          <div className="mb-4 desktop:mb-0 desktop:w-[478px] desktop:mx-auto px-4 py-4 overflow-x-auto">
            <p>
              Volver
            </p>
          ...
          <div className="desktop:w-[340px] desktop:flex-shrink-0 desktop:flex-grow-0">
          ...
          <div className="hidden desktop:block desktop:w-[309px] desktop:flex-shrink-0 desktop:flex-grow-0">
        ...
        <div className="desktop:hidden mt-4 space-y-4">
          <Card>
            <div className="space-y-2 mb-4">
              <Button variant="primary" size="lg" fullWidth>
                Comprar ahora
